...
//         success: function (json) {// LibraryListDto 의 전체 데이터 (json)
//             console.log('라이브러리 데이터 : ' + json);
            
//             for (i in json)
//             {
//                 console.log(json[i].libCode);
//             }
...
//                         type: "get",
//                         url: "/dddddd",
//                         data: { : isbnNum[isbnNum.length - 1] }, // 도서 데이터가 담긴 result안에 isbn을 가져와서 파라미터를 넣어준다(isbn이 여러개라면 split로 잘라준 isbn 마지막 부분을 넣어준다.)
//                         contentType: "application/json; charset=utf-8",
//                         dataType: "json",
//                         async: false,
