...
// 	// public int userLoingPass(UserDto userDto, HttpSession session, HttpServletRequest request, HttpServletResponse response) {

// 	// 	// userLogin.html에서 아이디기억하기 name값(remember) 가져오기
// 	// 	String user_check = request.getParameter("remember_userId");

// 	// 	// 로그인 메서드
// 	// 	int result = login_service.userLogin_service(userDto, session, user_check, response);
