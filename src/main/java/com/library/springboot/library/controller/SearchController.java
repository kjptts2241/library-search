...
public class SearchController {
     ...
     * 도서관 전체 데이터 조회
     */
    @GetMapping("/data/v1/librarylist")
    public List<LibraryList> LibraryList() throws IOException {
         List<LibraryList> LibraryListDto = searchService.LibraryList(); // libraryListService에 있는 LibraryListSearch 함수를 실행시켜 LibraryListDto를 보내준다
     ...
     * 도서 상세 검색 결과 조회
     */
    @GetMapping("/api/v1/searchDetails")
     ...
     * 도서 소장 도서관 조회
     */
    @GetMapping("/api/v1/bookCollection")
     ...
     * 인기대출 도서 조회
     */
    @PostMapping("/api/v1/popularBook")
