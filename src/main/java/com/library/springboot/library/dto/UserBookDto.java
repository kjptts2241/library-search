...
public class UserBookDto {
    ...
    @Builder
    public UserBookDto(String imageUrl, String titleInfo, String typeName, String authorInfo, String pubInfo, String menuName, String mediaName, String licText, String regDate, int isbn, String callNo, String kdcCode1s, String kdcName1s) {
